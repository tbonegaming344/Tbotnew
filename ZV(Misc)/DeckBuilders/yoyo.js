...
on (cc.deckinfo = pb.deckinfo)`);
    let yoyo = new EmbedBuilder()
      .setTitle("Yoyo Decks")
      .setDescription(
        `To view the Decks Made By Yoyo please select an option from the select menu below! To view all of Yoyo decks select the midrange option from the select menu
