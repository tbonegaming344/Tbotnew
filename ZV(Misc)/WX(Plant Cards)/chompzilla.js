...
module.exports = {
  ...
  const lsnap2 = new CreateButtons("helpcombo", "mred2");
  const mred2 = new CreateButtons("lasersnap2", "mop2");
  const mop2 = new CreateButtons("midred2", "combohelp");
  const midrangerow = new CreateButtons("mopribus3", "lsnap3");
  const lsnap3 = new CreateButtons("helpmid", "mred3");
  const mred3 = new CreateButtons("lasersnap3", "mop3");
  ...
  const lsnap4 = new CreateButtons("healcontrol", "mred4");
  const mred4 = new CreateButtons("lasersnap4", "mop4");
