  ...
  run: async (client, message, args) => {
   ...
   const select = new StringSelectMenuBuilder()
    ...
    let nc = new EmbedBuilder()
      ...
      .setDescription(`To view the Night Cap decks please click on the buttons below!
...
.setImage(`${result[4].brainclones}`)
    ...
    let cyggro = new EmbedBuilder()
      .setTitle(`${result[5].cyggro}`)
      .setDescription(`${result[3].cyggro}`)
      .setFooter({ text: `${result[2].cyggro}` })
      .addFields(
        {
          name: "Deck Type",
          value: `${result[6].cyggro}`,
          inline: true,
        },
        {
          name: "Archetype",
          value: `${result[0].cyggro}`,
          inline: true,
        },
        {
          name: "Deck Cost",
          value: `${result[1].cyggro}`,
          inline: true,
        }
      )
      .setColor("Random")
      .setImage(`${result[4].cyggro}`);
    ...
    let hyperswarm = new EmbedBuilder()
      .setTitle(`${result[5].hyperswarm}`)
      .setDescription(`${result[3].hyperswarm}`)
      .setFooter({ text: `${result[2].hyperswarm}` })
      .addFields(
        {
          name: "Deck Type",
          value: `${result[6].hyperswarm}`,
          inline: true,
        },
        {
          name: "Archetype",
          value: `${result[0].hyperswarm}`,
          inline: true,
        },
        {
          name: "Deck Cost",
          value: `${result[1].hyperswarm}`,
          inline: true,
        }
      )
      .setColor("Random")
      .setImage(`${result[4].hyperswarm}`);
    let joashrooms = new EmbedBuilder()
      .setTitle(`${result[5].joashrooms}`)
      .setDescription(`${result[3].joashrooms}`)
      .setFooter({ text: `${result[2].joashrooms}` })
      .addFields(
        {
          name: "Deck Type",
          value: `${result[6].joashrooms}`,
          inline: true,
        },
        {
          name: "Archetype",
          value: `${result[0].joashrooms}`,
          inline: true,
        },
        {
          name: "Deck Cost",
          value: `${result[1].joashrooms}`,
          inline: true,
        }
      )
      .setColor("Random")
      .setImage(`${result[4].joashrooms}`);
    ...
    let midcap = new EmbedBuilder()
      .setTitle(`${result[5].midcap}`)
      .setDescription(`${result[3].midcap}`)
      .setFooter({ text: `${result[2].midcap}` })
      .addFields(
        {
          name: "Deck Type",
          value: `${result[6].midcap}`,
          inline: true,
        },
        {
          name: "Archetype",
          value: `${result[0].midcap}`,
          inline: true,
        },
        {
          name: "Deck Cost",
          value: `${result[1].midcap}`,
          inline: true,
        }
      )
      .setColor("Random")
      .setImage(`${result[4].midcap}`);
