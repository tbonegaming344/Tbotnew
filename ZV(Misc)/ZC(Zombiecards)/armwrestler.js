...
module.exports = {
	...
	run: async(client, message, args) => {
			const embed = new EmbedBuilder()		.setThumbnail("https://static.wikia.nocookie.net/plantsvszombies/images/3/34/Arm_WrestlerH.png/revision/latest/scale-to-width-down/225?cb=20160625173956")
