...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    const addDeckText2 = new TextDisplayBuilder().setContent([
      "Please use the submitdeck slash command to submit your deck.",
      "Otherwise use the updatedeck slash command to update one of your existing decks or another creator's deck."
    ].join("\n"));
