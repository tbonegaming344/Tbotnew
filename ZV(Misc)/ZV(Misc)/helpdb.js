...
module.exports = {
	...
	category: `Miscellaneous`,
		run: async(client, message, args) =>{ 
			...
			.setCustomId('starter')
			.setPlaceholder('Select an option below to view certain Decktypes or archtypes!')
			.addOptions(
...
Note: the decks are in alphabetical order not by hero and there are ${commands.length} commands in the database with ${allpdecks.length} plant decks and ${allzdecks.length} zombie decks`)
		...
		.addFields({
			name: "Budget Decks", 
			value: "Good for when you don't want to spend money on the game and don't have a lot of sparks or a lot of the rarest cards in the game, but aren't as good as the top decks at the highest level of the game."
		},{
			name: "Competitive Decks",
			value: "Some of the best decks in the game."
		}, {
			name: "Ladder Decks",
			value: "Useful for Ranked Online Multiplayer, but crumbles into more competitive decks."
		}, 
{
	name: "Meme Decks",
	value: "Not designed to be competitive, and never was, even during the deck building process. Was simply made for weird/fun combos and wasn't made with any competitive meta in mind."
})
.setFooter({text: "Credit to Iceiboi for deck type explainations"})
	  const allpdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to naviagte through all the plant decks or ping tbot with one of the decknames above to see a specific plant deck 
Note: there are ${allpdecks.length} plant decks in the database`})
	  const budgetpdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the budget plant decks or use the commands above to see a specific budget plant deck
Note: there are ${budgetpdecks.length} budget plant decks in the database`})
	  const comppdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the competitive plant decks or use the commands above to see a specific competitive plant deck
Note: there are ${comppdecks.length} competitive plant decks in the database`})
	  const ladderpdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the ladder plant decks or use the commands above to see a specific ladder plant deck
Note: there are ${ladderpdecks.length} ladder plant decks in the database`})
	  const memepdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the meme plant decks or use the commands above to see a specific meme plant deck
Note: there are ${memepdecks.length} meme plant decks in the database`})
	  const aggropdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the aggro plant decks or use the commands above to see a specific aggro plant deck
Note: there are ${aggropdecks.length} aggro plant decks in the database`})
	  const combopdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the combo plant decks or use the commands above to see a specific combo plant deck
Note: there are ${combopdecks.length} combo plant decks in the database`})
	  const controlpdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the control plant decks or use the commands above to see a specific control plant deck
Note: there are ${controlpdecks.length} control plant decks in the database`})
	  const midrangepdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the midrange plant decks or use the commands above to see a specific midrange plant deck
Note: there are ${midrangepdecks.length} midrange plant decks in the database`})
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the tempo plant decks or use the commands above to see a specific tempo plant deck
...
.setColor("Random")
.setFooter({text: `Click the buttons below to navigate through all the zombie decks or use the commands above to see a specific zombie deck(PS: ping Tbot with deckname to see specific decks!)
Note: there are ${allzdecks.length} zombie decks in the database`})
	  const budgetzdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the budget zombie decks or use the commands above to see a specific budget zombie deck
Note: there are ${budgetzdecks.length} budget zombie decks in the database`})
	  const compzdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the competitive zombie decks or use the commands above to see a specific competitive zombie deck
Note: there are ${compzdecks.length} competitive zombie decks in the database`})
	  const ladderzdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the ladder zombie decks or use the commands above to see a specific ladder zombie deck
Note: there are ${ladderzdecks.length} ladder zombie decks in the database`})
	  const memezdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the meme zombie decks or use the commands above to see a specific meme zombie deck
Note: there are ${memezdecks.length} meme zombie decks in the database`})
	  const aggrozdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the aggro zombie decks or use the commands above to see a specific aggro zombie deck
Note: there are ${aggrozdecks.length} aggro zombie decks in the database`})
	  const combozdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the combo zombie decks or use the commands above to see a specific combo zombie deck
Note: there are ${combozdecks.length} combo zombie decks in the database`})
	  const controlzdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the control zombie decks or use the commands above to see a specific control zombie deck
Note: there are ${controlzdecks.length} control zombie decks in the database`})
	  const midrangezdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the midrange zombie decks or use the commands above to see a specific midrange zombie deck
Note: there are ${midrangezdecks.length} midrange zombie decks in the database`})
	  const tempozdecksEmbed = new EmbedBuilder()
		...
		.setColor("Random")
		.setFooter({text: `Click the buttons below to navigate through all the tempo zombie decks or use the commands above to see a specific tempo zombie deck
Note: there are ${tempozdecks.length} tempo zombie decks in the database`})
	  const m = await message.channel.send({embeds: [embed], components: [selectrow]})
	...
	collector.on('collect', async i => {
		if(i.customId == "starter"){
			...
			if(value == "budgetpdecks"){
				await i.update({embeds: [budgetpdecksEmbed], components: [budgetprow]})
			}
			if(value == "comppdecks"){
				await i.update({embeds: [comppdecksEmbed], components: [compprow]})
			}
			if(value == "ladderpdecks"){
				await i.update({embeds: [ladderpdecksEmbed], components: [ladderprow]})
			}
			if(value == "memepdecks"){
			...
			if(value == "controlpdecks"){
				await i.update({embeds: [controlpdecksEmbed], components: [controlprow]})
			}
			if(value == "midrangepdecks"){
				await i.update({embeds: [midrangepdecksEmbed], components: [midrangeprow]})
			}
			if(value == "tempopdecks"){
				await i.update({embeds: [tempopdecksEmbed], components: [tempoprow]})
			}
			if(value == "budgetzdecks"){
				await i.update({embeds: [budgetzdecksEmbed], components: [budgetzrow]})
			}
			if(value == "compzdecks"){
				await i.update({embeds: [compzdecksEmbed], components: [compzrow]})
			}
			if(value == "ladderzdecks"){
				await i.update({embeds: [ladderzdecksEmbed], components: [ladderzrow]})
			}
			if(value == "memezdecks"){
			...
			if(value == "controlzdecks"){
				await i.update({embeds: [controlzdecksEmbed], components: [controlzrow]})
			}
			if(value == "midrangezdecks"){
				await i.update({embeds: [midrangezdecksEmbed], components: [midrangezrow]})
			}
		...
		if(i.customId == "propackage" || i.customId == "professorpackage"){
			await i.update({embeds: [professorpackage], components: [propackage]})
		}
		if(i.customId == "propackage2" || i.customId == "professorpackage2"){
			await i.update({embeds: [professorpackage], components: [propackage2]})
		}
		if(i.customId == "propackage3" || i.customId == "professorpackage3"){
			await i.update({embeds: [professorpackage], components: [propackage3]})
		}
		...
		if(i.customId == "terrifyster" || i.customId == "terrifytricksterazzi"){
			await i.update({embeds: [terrifytricksterazzi], components: [terrifyster]})
		}
		if(i.customId == "terrifyster2" || i.customId == "terrifytricksterazzi2"){
			await i.update({embeds: [terrifytricksterazzi], components: [terrifyster2]})
		}
		if(i.customId == "terrifyster3" || i.customId == "terrifytricksterazzi3"){
			await i.update({embeds: [terrifytricksterazzi], components: [terrifyster3]})
		}
		if(i.customId == "terrifyster4" || i.customId == "terrifytricksterazzi4"){
			await i.update({embeds: [terrifytricksterazzi], components: [terrifyster4]})
		}
